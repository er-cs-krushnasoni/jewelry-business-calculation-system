    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-blue-800">
            <p className="font-medium">Phase 4A: Basic Calculations (No Rounding)</p>
            <p className="text-blue-700 mt-1">
              Calculations show exact values without rounding. Rounding logic will be implemented in Phase 4B.
            </p>
          </div>
        </div>
      </div>
      ...
      {selectedCategory && selectedCategory.description && (
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
          ...
          <p className="font-medium text-purple-900 mb-2">{selectedCategory.description}</p>
        </div>
      )}
        ...
        <div className="space-y-4 border-t-2 border-gray-200 pt-6">
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-300 rounded-xl p-6 text-center">
            ...
            <div className="text-5xl font-bold text-green-900">
              ₹{formatNumber(result.finalSellingAmount)}
            </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="text-left">
                    ...
                    <div className="text-3xl font-bold text-purple-900">
                      ₹{formatNumber(result.marginBreakdown.ourMargin)}
                    </div>
                  </div>
                </div>
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex items-center gap-2 pl-6 mt-3">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="font-mono text-purple-900">₹{formatNumber(result.marginBreakdown.ourMargin)}</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2 border-t-2 border-purple-400 pt-2 mt-2">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="font-mono font-bold text-green-900 text-lg">₹{formatNumber(result.finalSellingAmount)}</div>
                          </div>
                        </div>
                      </div>
                    </div>
