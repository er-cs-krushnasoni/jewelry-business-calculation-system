                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="text-left">
                          ...
                          <div className="text-xs text-green-600 mt-1">
                            ({formatNumber(result.resaleCalculations.directResale.marginPercentage)}% of Total Amount)
                          </div>
                        </div>
                      </div>
                      {canSeeMarginBreakdown && (
                          ...
                          <div className="bg-white rounded-lg p-3 border border-green-200">
                            ...
                            <div className="ml-4 space-y-1 text-xs">
                              <div className="flex justify-between text-green-700">
                                <span>Base Cost ({result.resaleCalculations.percentages.buyingFromWholesaler}%)</span>
                                <span>₹{formatCurrency(result.resaleCalculations.directResale.breakdown.wholesalerCostBreakdown.baseCost)}</span>
                              </div>
                              <div className="flex justify-between text-green-700">
                                <span>Labour Charges: ₹{formatNumber(result.resaleCalculations.directResale.labourInfo.labourPerGram)}/g × {result.input.weight}g</span>
                          ...
                          <div className="bg-green-100 rounded-lg p-4 border-2 border-green-300">
                            <div className="space-y-2 text-sm">
                              <div className="pt-2 border-t border-green-300 flex justify-between items-center font-bold">
                                <span className="text-green-900">Direct Resale Margin:</span>
              ...
              {result.resaleCalculations.polishRepairResale && (
                result.resaleCalculations.polishRepairResale.available ? (
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-300 rounded-xl p-6">
                    ...
                    <div className="text-center mb-4">
                      <div className="text-sm font-medium text-blue-700 mb-2">Final Polish/Repair Value</div>
                      ...
                      <div className="text-sm text-blue-600 mt-2">
                        {canSeeMarginBreakdown ? (
                          ...
                          <>for {result.input.weight}g after polish/repair</>
                        )}
                      </div>
                      {canSeeMarginBreakdown && result.resaleCalculations.polishRepairResale.breakdown.roundingApplied && (
                        <div className="text-xs text-blue-600 mt-1">
                          (Resale Value: ₹{formatCurrency(result.resaleCalculations.polishRepairResale.totalAmount)} - Polish Labour: ₹{formatCurrency(result.resaleCalculations.polishRepairResale.labourInfo.polishRepairLabour.totalLabourCharges)})
                        </div>
                      )}
                    </div>
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div className="text-left">
                              ...
                              <div className="text-xs text-blue-600 mt-1">
                                ({formatNumber(result.resaleCalculations.polishRepairResale.marginPercentage)}% of Final Value)
                              </div>
                            </div>
                          </div>
                          {canSeeMarginBreakdown && (
                            ...
                            <div className="space-y-3">
                              <div className="bg-white rounded-lg p-3 border border-blue-200">
                                ...
                                <div className="ml-4 space-y-1 text-xs">
                                  ...
                                  <div className="flex justify-between text-blue-700">
                                    <span>Wholesaler Labour: ₹{formatNumber(result.resaleCalculations.polishRepairResale.labourInfo.wholesalerLabour.labourPerGram)}/g × {formatNumber(result.resaleCalculations.polishRepairResale.labourInfo.wholesalerLabour.calculatedOnWeight)}g</span>
                              ...
                              <div className="bg-white rounded-lg p-3 border border-blue-200">
                                <div className="text-sm font-semibold flex justify-between text-blue-700 mb-2">
                                  <span>Polish/Repair Resale Value ({result.resaleCalculations.percentages.polishRepairResale}%)</span>
                                ...
                                <div className="pt-2 border-t border-blue-200">
                                  <div className="text-sm font-semibold flex justify-between text-blue-700">
                                    <span>Polish/Repair Labour: ₹{formatNumber(result.resaleCalculations.polishRepairResale.labourInfo.polishRepairLabour.labourPerGram)}/g × {result.resaleCalculations.polishRepairResale.labourInfo.polishRepairLabour.calculatedOnWeight}g</span>
                              ...
                              <div className="bg-blue-100 rounded-lg p-4 border-2 border-blue-300">
                                <div className="space-y-2 text-sm">
                                  <div className="pt-2 border-t border-blue-300 flex justify-between items-center font-bold">
                                    <span className="text-blue-900">Net Margin After Polish/Repair:</span>
